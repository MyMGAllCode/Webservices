...
public class GeoIPServiceSoap_Stub
    ...
    implements com.nareshit.proxy.GeoIPServiceSoap {
     ...
     */
    public com.nareshit.proxy.GeoIP getGeoIP(java.lang.String IPAddress)
        ...
        try {
            ...
            com.nareshit.proxy.GetGeoIP _myGetGeoIP = new com.nareshit.proxy.GetGeoIP();
            ...
            com.nareshit.proxy.GetGeoIPResponse _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (com.nareshit.proxy.GetGeoIPResponse)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (com.nareshit.proxy.GetGeoIPResponse)_responseObj;
            }
     ...
     */
    public com.nareshit.proxy.GeoIP getGeoIPContext()
        throws java.rmi.RemoteException {
        ...
        try {
            ...
            com.nareshit.proxy.GetGeoIPContext _myGetGeoIPContext = new com.nareshit.proxy.GetGeoIPContext();
            ...
            com.nareshit.proxy.GetGeoIPContextResponse _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (com.nareshit.proxy.GetGeoIPContextResponse)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (com.nareshit.proxy.GetGeoIPContextResponse)_responseObj;
            }
    ...
    public void _initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns1_myGetGeoIPContextResponse_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.nareshit.proxy.GetGeoIPContextResponse.class, ns1_GetGeoIPContextResponse_TYPE_QNAME);
        ns1_myGetGeoIPContext_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.nareshit.proxy.GetGeoIPContext.class, ns1_GetGeoIPContext_TYPE_QNAME);
        ns1_myGetGeoIPResponse_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.nareshit.proxy.GetGeoIPResponse.class, ns1_GetGeoIPResponse_TYPE_QNAME);
        ns1_myGetGeoIP_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.nareshit.proxy.GetGeoIP.class, ns1_GetGeoIP_TYPE_QNAME);
    }
    
    private static final javax.xml.namespace.QName _portName = new QName("http://www.webservicex.net/", "GeoIPServiceSoap");
    private static final int GetGeoIP_OPCODE = 0;
    private static final int GetGeoIPContext_OPCODE = 1;
