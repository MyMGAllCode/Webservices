...
public class Book implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = Book
       Namespace URI = http://domain.bookService.com
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            java.lang.String namespacePrefix = registerPrefix(xmlWriter,
                    "http://domain.bookService.com");

            if ((namespacePrefix != null) &&
                    (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":Book", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Book", xmlWriter);
        ...
        namespace = "http://domain.bookService.com";
    ...
    private static java.lang.String generatePrefix(java.lang.String namespace) {
        if (namespace.equals("http://domain.bookService.com")) {
            return "ns1";
        }
    ...
    public static class Factory {
         ...
         */
        public static Book parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Book".equals(type)) {
                            ...
                            return (Book) com.bookservice.sevices.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://domain.bookService.com", "author").equals(
                            reader.getName())) ||
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://domain.bookService.com", "isbn").equals(
                            reader.getName())) ||
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://domain.bookService.com", "price").equals(
                            reader.getName())) ||
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://domain.bookService.com", "title").equals(
                            reader.getName())) ||
