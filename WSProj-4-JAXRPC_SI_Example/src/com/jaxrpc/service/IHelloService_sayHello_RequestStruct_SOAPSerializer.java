...
public class IHelloService_sayHello_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.jaxrpc.service.IHelloService_sayHello_RequestStruct instance = new com.jaxrpc.service.IHelloService_sayHello_RequestStruct();
        com.jaxrpc.service.IHelloService_sayHello_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.jaxrpc.service.IHelloService_sayHello_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.jaxrpc.service.IHelloService_sayHello_RequestStruct instance = (com.jaxrpc.service.IHelloService_sayHello_RequestStruct)obj;
