...
public class IHelloService_sayHello_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public IHelloService_sayHello_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.nareshit.proxy.IHelloService_sayHello_RequestStruct instance = new com.nareshit.proxy.IHelloService_sayHello_RequestStruct();
        com.nareshit.proxy.IHelloService_sayHello_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.nareshit.proxy.IHelloService_sayHello_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.nareshit.proxy.IHelloService_sayHello_RequestStruct instance = (com.nareshit.proxy.IHelloService_sayHello_RequestStruct)obj;
