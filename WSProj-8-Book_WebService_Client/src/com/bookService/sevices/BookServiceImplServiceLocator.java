...
public class BookServiceImplServiceLocator extends org.apache.axis.client.Service implements com.bookService.sevices.BookServiceImplService {
    ...
    private java.lang.String BookServiceImpl_address = "http://localhost:3030/Book_WebService_Axis/services/BookServiceImpl";
    ...
    public com.bookService.sevices.BookServiceImpl getBookServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bookService.sevices.BookServiceImplSoapBindingStub _stub = new com.bookService.sevices.BookServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bookService.sevices.BookServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bookService.sevices.BookServiceImplSoapBindingStub _stub = new com.bookService.sevices.BookServiceImplSoapBindingStub(new java.net.URL(BookServiceImpl_address), this);
                _stub.setPortName(getBookServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://sevices.bookService.com", "BookServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://sevices.bookService.com", "BookServiceImpl"));
        }
